    ...
    <div
      className={`group relative rounded-3xl border bg-white flex flex-col overflow-hidden transition-all duration-200
        ${disabled
          ...
          : " hover:shadow-lg hover:-translate-y-0.5 hover:border-indigo-200 border-slate-100 shadow-sm"
        }`}
    >
      {/* Top colour band */}
      <div
            ...
            <div className="px-7 pb-7 flex gap-3">
              ...
              <button
                ...
                className="flex-1 rounded-xl bg-indigo-600 py-2.5 text-sm font-semibold
                  text-white hover:bg-indigo-700 active:scale-[0.98] transition-all cursor-pointer"
              >
                Confirm
              </button>
            </div>
