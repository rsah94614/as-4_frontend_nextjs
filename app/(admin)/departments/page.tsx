    ...
    return (
        <>
            <main className="flex-1 overflow-y-auto overflow-x-hidden p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-5">
                ...
                >
                    <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-white tracking-wide">Departments</h1>
                    <button
                        onClick={openCreate}
                        className="w-full sm:w-auto flex items-center justify-center gap-2 font-semibold text-white px-5 py-2.5 rounded-lg transition-all hover:opacity-90 active:scale-95"
